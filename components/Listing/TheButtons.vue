<template>
  <div class="listings-section_actions card-actions" v-if="!isAdmin || checkRoute()">
    <button class="btn" data-bs-toggle="modal" data-bs-target="#modal" @click="handleButtonClick">
  ...
  <div class="listings-section_actions card-actions" v-else>
    <button class="btn" @click="handleButtonClick();decline(listing.id)">
    ...
    <button class="btn" @click="handleButtonClick();approve(listing.id)">        
